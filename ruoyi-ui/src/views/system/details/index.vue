  ...
  <div class="app-container">
      <!--消费明细数据-->
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange" width="100">
          ...
          <el-table-column label="用户编号" align="center" prop="cardNum" width="100"/>
          ...
          <el-table-column label="交易类型" :formatter="statusFormat" align="center" prop="type" width="100"/>
          <el-table-column label="交易详情" align="center" prop="transaction" width="300"/>
          <el-table-column label="备注" align="center" prop="remark" />
          <el-table-column label="交易时间" align="center" prop="createdTime" width="160">
...
export default {
  ...
  created() {
    ...
    this.getDicts("sys_transaction").then(response => {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listDetails(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    statusFormat(row, column) {
              ...
              return this.selectDictLabel(this.transactionOptions, row.type);
            },
    // 取消按钮
    cancel() {
      this.open = false;
